...
| Preamble fenced bash blocks (```bash) as "reference examples" | LLM executes the preamble blocks as though they were step commands, emitting stray output (e.g., `::group::` markers before Step 0) | Put reference examples in prose with inline `code` spans, never standalone ```bash blocks; open the section with "reference guidance — do not execute directly"; keep every executable command inside a numbered Step |
...
> Sources for pitfalls table: [AGENTS.md](../AGENTS.md) (conventions section), [Plugin Authoring guide](PLUGIN-AUTHORING.md), [Claude Code Skills docs](https://code.claude.com/docs/en/skills), [PR #40](https://github.com/rube-de/cc-skills/pull/40), [PR #41](https://github.com/rube-de/cc-skills/pull/41), [PR #43](https://github.com/rube-de/cc-skills/pull/43), [Issue #59](https://github.com/rube-de/cc-skills/issues/59), [Issue #115](https://github.com/rube-de/cc-skills/issues/115), [PR #157](https://github.com/rube-de/cc-skills/pull/157), [PR #210](https://github.com/rube-de/cc-skills/pull/210)
