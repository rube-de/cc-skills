...
{
  "decision": "block",
  "reason": "MANDATORY REVIEW NOT POSTED: You must execute Step 7 (`post-review.sh <PR#> \"\${TMPDIR:-/tmp}/ci-review-payload-<PR#>.json\"` as specified in SKILL.md) via the Bash tool to post the review to GitHub before finishing."
}
JSON
